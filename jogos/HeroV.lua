...
function Hero:new(x,y,w)
  local obj = {px=x,
               py=y,
               width = w,
               heigth = h,
               movimento = 1,-- 1 = parado , 2 = andar,3 = pulo,4= espada,5=chute
               walk = {},
               idle = {},
               slash = {},
               kick = {},
...
function Hero:getMapaIndX()
  return self.mapa_ind_x
end

function Hero:getMapaIndY()
  return self.mapa_ind_y
end

function Hero:setMapaIndX(x)
  self.mapa_ind_x = x
end

function Hero:setMapaIndY(y)
  self.mapa_ind_y = y
end
