  ...
  for line in file:lines() do
    ...
    for j=1, #line, 1 do
      ...
      elseif t == "B" then
        ...
        mapa[i][j].fixture = love.physics.newFixture(mapa[i][j].body , mapa[i][j].shape, 0.2)
        mapa[i][j].tile = t
      else
        mapa[i][j] = {}
        mapa[i][j].tile = t 
...
function love.load()
  love.window.setTitle("Tiro de Frango")
  ...
  chicken_body.shape = love.physics.newCircleShape(32) 
